...
namespace Binance
{
	...
	{
		/// <summary>The unique FeedName is BINANCE</summary>		
		public static string FeedName() { return "BINANCE"; }
		/// <summary>The readable FeedName is Binance</summary>		
		public static string Name() { return "Binance"; }
		/// <summary>The Data Source Description is Binance</summary>		
		public static string Source() { return "Binance"; }
		/// <summary>The Module output is BINANCE.dll</summary>		
		public static string Module() { return "BINANCE.dll"; }
		/// <summary>Appears on the SystemTray Menu under the Data Feeds Sub Menu</summary>
		public static string TrayMenu() { return Constants.Menu[Constants.MenuKind.TradingPlatforms]; }
